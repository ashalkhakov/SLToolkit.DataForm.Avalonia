...
using VR = System.ComponentModel.DataAnnotations.ValidationResult;
...
namespace System.Windows.Controls.UnitTests
{
    ...
    public static class DataClassWithValidationValidator
    {
        ...
        public static VR IsDataClassWithValidationValid(object value, ValidationContext context)
        {
            ...
            {
                return new VR("IntProperty cannot be equal to StringProperty.", new string[] { "IntProperty", "StringProperty" });
            }
