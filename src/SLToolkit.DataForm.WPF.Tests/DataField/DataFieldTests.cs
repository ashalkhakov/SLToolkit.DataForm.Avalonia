...
namespace SLToolkit.DataForm.WPF.Tests
{
    ...
    /// </summary>
    [TestClass]
    public class DataFieldTests : PresentationTest
    {
        ...
        {
            AddToPanelInStackPanelAndWaitForLoad();
        ...
        public async Task ChangeDescriptionViewerPosition()
        {
            this.EnqueueConditional(() => this._dataField != null);
        ...
        public void ChangeDescriptionViewerStyle()
        {
            ...
            this.EnqueueCallback(() =>
            {
                ...
                Assert.AreEqual(20.0, this._dataField.DescriptionViewer.FontSize);

                Style style2 = new Style(typeof(DescriptionViewer));
                style2.Setters.Add(new Setter(Control.FontSizeProperty, 30.0));
                this._dataField.DescriptionViewerStyle = style2;

                Assert.AreEqual(style2, this._dataField.DescriptionViewerStyle);
                Assert.AreEqual(30.0, this._dataField.DescriptionViewer.FontSize);
            });
        ...
        public void ChangeLabelStyle()
        {
            ...
            this.EnqueueCallback(() =>
            {
                ...
                Assert.AreEqual(20.0, this._dataField.InternalLabel.FontSize);
                ...
                Assert.AreEqual(30.0, this._dataField.InternalLabel.FontSize);
            });
        ...
        private void AddToPanelInStackPanelAndWaitForLoad()
        {
            ...
            EnqueueConditional(() => this._dataFieldLoaded);
        }
