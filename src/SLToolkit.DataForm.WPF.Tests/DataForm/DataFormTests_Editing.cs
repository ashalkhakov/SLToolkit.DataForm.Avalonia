...
namespace System.Windows.Controls.UnitTests
{
    ...
    public class DataFormTests_Editing : DataFormTests_Base
    {
        ...
        {
            DataFormApp_ReadOnlyProperty2 dataFormApp = null;
            EnqueueCallback(() =>
            {
                dataFormApp = new DataFormApp_ReadOnlyProperty2();
        ...
        {
            DataFormApp_ReadOnlyProperty3 dataFormApp = null;
            EnqueueCallback(() =>
            {
                dataFormApp = new DataFormApp_ReadOnlyProperty3();
                dataFormApp.dataForm.CurrentItem = new DataClassWithReadOnlyProperty();
                this.DataFormAppBase = dataFormApp;
            });
            this.AddToPanelAndWaitForLoad();
        ...
        {
            DataFormApp_ReadOnlyProperty1 dataFormApp = null;
            EnqueueCallback(() =>
            {
                dataFormApp = new DataFormApp_ReadOnlyProperty1();
                dataFormApp.dataForm.CurrentItem = new DataClassWithReadOnlyProperty();
                this.DataFormAppBase = dataFormApp;
            });
            this.AddToPanelAndWaitForLoad();
        ...
        public void EditInPagedCollectionViewBeforeEditingInDataForm()
        {
            ...
            EnqueueCallback(() =>
            {
                ...
                dataClass = pcv.CurrentItem as DataClass;
        ...
        public void EnsureCanCancelEditWithInitialAutoEdit()
        {
            ...
            DataClassList dataClassList = null;

            EnqueueCallback(() =>
            {
                dataFormApp = new DataFormApp_FieldsWithInitialAutoEdit();
                this.DataFormAppBase = dataFormApp;
                dataClassList = DataClassList.GetDataClassList(5, ListOperations.All);
        ...
        public void EnsureCancelEditDoesNotThrowExceptionWhenNotEditing()
        {
            ...
            EnqueueCallback(() =>
            {
                dataClassList = DataClassList.GetDataClassList(3, ListOperations.All);
        ...
        {
            DataFormApp_FieldsWithDifferentBinding dataFormApp = null;
            ButtonBase commitButton = null;

            this.EnqueueCallback(() =>
            {
                dataFormApp = new DataFormApp_FieldsWithDifferentBinding();
        ...
        {
            DataFormApp_FieldsWithUneditableType dataFormApp = null;
            EnqueueCallback(() =>
            {
                dataFormApp = new DataFormApp_FieldsWithUneditableType();
                this.DataFormAppBase = dataFormApp;
                dataFormApp.dataForm.CurrentItem = new DataClassWithUneditableType();
            });
