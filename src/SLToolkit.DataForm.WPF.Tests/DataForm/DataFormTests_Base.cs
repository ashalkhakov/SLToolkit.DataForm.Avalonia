...
namespace System.Windows.Controls.UnitTests
{
    ...
    /// </summary>
    public class DataFormTests_Base : PresentationTest
    {
        /// <summary>
        ...
        /// </summary>
        protected IList<SLToolkit.DataForm.WPF.Controls.Label> DataFormLabels
        {
            get
            {
                IList<SLToolkit.DataForm.WPF.Controls.Label> labels = new List<SLToolkit.DataForm.WPF.Controls.Label>();
        ...
        private DataForm GetDataForm()
        {
            ...
            DataForm dataForm = this.DataFormAppBase.FindName("dataForm") as DataForm;
