...
namespace System.Windows.Controls.UnitTests
{
    ...
    public class DataFormTests_Miscellaneous : DataFormTests_Base
    {
        ...
        {
            DataFormApp_Standard dataFormApp = null;

            this.EnqueueCallback(() =>
            {
                dataFormApp = new DataFormApp_Standard();
        ...
        {
            DataFormApp_FieldsWithInitialAutoEdit dataFormApp = null;
        ...
        {
            DataFormApp_Standard dataFormApp = null;
            PagedCollectionView cv = null;

            this.EnqueueCallback(() =>
            {
                dataFormApp = new DataFormApp_Standard();
                cv = new PagedCollectionView(DataClassList.GetDataClassList(2, ListOperations.All));
        ...
        public void EnsureCurrentIndexSyncedAfterCollectionViewMovesToAfterLast()
        {
            ...
            {
                dataFormApp = new DataFormApp_Standard();
                pcv = new PagedCollectionView(DataClassList.GetDataClassList(2, ListOperations.All));
        ...
        {
            DataFormApp_Fields dataFormApp = null;
            DataClassWithValidation dataClass = null;

            this.EnqueueCallback(() =>
            {
                dataFormApp = new DataFormApp_Fields();
                dataFormApp.dataForm.AutoCommit = false;
                dataClass = new DataClassWithValidation() { StringProperty = "test string 0" };
        ...
        public void EnsureFirstEditableFieldFocused()
        {
            ...
            this.EnqueueCallback(() =>
            {
                Assert.AreEqual(this.DataFormInputControls[0], FocusManager.GetFocusedElement(Window.GetWindow(this.DataFormInputControls[0])));
            });
        ...
        {
            DataFormApp_TemplatesWithTabIndex dataFormApp = null;

            this.EnqueueCallback(() =>
            {
                dataFormApp = new DataFormApp_TemplatesWithTabIndex();
                dataFormApp.dataForm.CurrentItem = new DataClass();
            ...
            this.EnqueueCallback(() =>
            {
                TextBox textBox = FocusManager.GetFocusedElement(Window.GetWindow(dataFormApp)) as TextBox;
        ...
        {
            DataFormApp_FieldsWithLayoutChanges dataFormApp = null;

            this.EnqueueCallback(() =>
            {
                dataFormApp = new DataFormApp_FieldsWithLayoutChanges();
        ...
        public void EnsureNonGroupedFieldsDoNotShrink()
        {
            ...
            DataFormApp_FieldsGroupWithNonGrouped dataFormApp = null;

            this.EnqueueCallback(() =>
            {
                dataFormApp = new DataFormApp_FieldsGroupWithNonGrouped();
                dataFormApp.dataForm.CurrentItem = new DataClass();
                this.DataFormAppBase = dataFormApp;
            });
        ...
        {
            DataFormApp_FieldsWithStylesWithTemplates dataFormApp = null;
        ...
        public void EnsureTemplateInDataFormStyleDoesNotThrowException()
        {
            ...
            this.EnqueueCallback(() =>
            {
                ...
                dataFormApp.dataForm.Style = (Style)dataFormApp.FindResource("DataFormStyle");
            });
        ...
        public void MoveCurrencyToNullWhenAppending()
        {
            ...
            this.EnqueueCallback(() =>
            {
                ...
                pcv = new PagedCollectionView(dataClassList);
        ...
        {
            DataFormApp_AutoGeneration dataFormApp = null;

            this.EnqueueCallback(() =>
            {
                dataFormApp = new DataFormApp_AutoGeneration();
                this.DataFormAppBase = dataFormApp;
            });
        ...
        public void SetDescriptionViewerStyleAtRuntime()
        {
            ...
            this.EnqueueCallback(() =>
            {
                ...
                style.Setters.Add(new Setter(DescriptionViewer.FontSizeProperty, 20.0));
                field.DescriptionViewerStyle = style;
                Assert.AreEqual(20.0, (this.DataFormDescriptions[0] as DescriptionViewer).FontSize);
            });
        ...
        public void SetLabelPositionAtRuntime()
        {
            ...
            this.EnqueueCallback(() =>
            {
                Assert.AreEqual(HorizontalAlignment.Right, (this.DataFormLabels[0] as SLToolkit.DataForm.WPF.Controls.Label).HorizontalAlignment);
            ...
            this.EnqueueCallback(() =>
            {
                Assert.AreEqual(HorizontalAlignment.Left, (this.DataFormLabels[0] as SLToolkit.DataForm.WPF.Controls.Label).HorizontalAlignment);
            });
        ...
        {
            DataFormApp_FieldsWithPropertyPath dataFormApp = null;
            
            this.EnqueueCallback(() =>
            {
                dataFormApp = new DataFormApp_FieldsWithPropertyPath();
                dataFormApp.dataForm.CurrentItem = new DataClass();
                this.DataFormAppBase = dataFormApp;
            });
            ...
            this.EnqueueCallback(() =>
            {
                SLToolkit.DataForm.WPF.Controls.Label label = this.DataFormLabels[0];
