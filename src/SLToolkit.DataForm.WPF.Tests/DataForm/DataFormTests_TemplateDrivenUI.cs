...
namespace System.Windows.Controls.UnitTests
{
    ...
    public class DataFormTests_TemplateDrivenUI : DataFormTests_Base
    {
        ...
        {
            DataFormApp_TemplatesWithElementNameBinding dataFormApp = null;
            EnqueueCallback(() =>
            {
                dataFormApp = new DataFormApp_TemplatesWithElementNameBinding();
            ...
            this.EnqueueCallback(() =>
            {
                ...
                var fieldLabel = stackPanel.Children[0] as SLToolkit.DataForm.WPF.Controls.Label;
        ...
        {
            DataFormApp_TemplatesWithBinding dataFormApp = null;
            ContentPresenter contentPresenter = null;

            EnqueueCallback(() =>
            {
                dataFormApp = new DataFormApp_TemplatesWithBinding();
                this.DataFormAppBase = dataFormApp;
                dataFormApp.dataForm.ItemsSource = DataClassList.GetDataClassList(1, ListOperations.All);
            });
            this.AddToPanelAndWaitForLoad();
        ...
        {
            DataFormApp_DirectContent dataFormApp = null;
            ContentPresenter contentPresenter = null;

            EnqueueCallback(() =>
            {
                dataFormApp = new DataFormApp_DirectContent();
                this.DataFormAppBase = dataFormApp;
                dataFormApp.dataForm.ItemsSource = DataClassList.GetDataClassList(1, ListOperations.All);
            });
            this.AddToPanelAndWaitForLoad();
        ...
        public void ReplaceDirectContentWithEditTemplate()
        {
            ...
            this.EnqueueCallback(() =>
            {
                ...
                dataFormApp.dataForm.EditTemplate = (DataTemplate)(dataFormApp.LayoutRoot).FindResource("editTemplate");
            });
        ...
        public void ReplaceDisplayTemplate()
        {
            ...
            this.EnqueueCallback(() =>
            {
                ...
                this.ExpectContentLoaded();
                this.DataForm.ReadOnlyTemplate = (DataTemplate)this.DataFormApp.LayoutRoot.FindResource("displayTemplate2");
            });
        ...
        public void ReplaceEditTemplate()
        {
            ...
            this.EnqueueCallback(() =>
            {
                ...
                this.ExpectContentLoaded();
                this.DataForm.EditTemplate = (DataTemplate)this.DataFormApp.LayoutRoot.FindResource("editTemplate2");
            });
        ...
        public void ReplaceInsertTemplate()
        {
            ...
            this.EnqueueCallback(() =>
            {
                ...
                this.ExpectContentLoaded();
                this.DataForm.NewItemTemplate = (DataTemplate)this.DataFormApp.LayoutRoot.FindResource("insertTemplate2");
            });
        ...
        {
            DataFormApp_Templates dataFormApp = null;
            ContentPresenter contentPresenter = null;

            EnqueueCallback(() =>
            {
                dataFormApp = new DataFormApp_Templates();
                dataFormApp.dataForm.CurrentItem = new DataClass();
                this.DataFormAppBase = dataFormApp;
