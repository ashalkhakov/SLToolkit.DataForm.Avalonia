...
namespace SLToolkit.DataForm.WPF.Common
{
    ...
    internal class ExtensionProperties : DependencyObject
    {
        ...
        /// </summary>
        public static readonly StyledProperty<bool> AreHandlersSuspended = DependencyProperty.RegisterAttached<FrameworkElement, ExtensionProperties, bool>(
    ...
    internal static class Extensions
    {
        ...
        private static Type _focusManagerType;
        private static MethodInfo _focusManagerGetFocusedElementMethodInfo;

        static Extensions()
        {
            _focusManagerType = typeof(FocusManager);
            _focusManagerGetFocusedElementMethodInfo = _focusManagerType.GetMethod("CallStaticMethod");
        }
        ...
        internal static bool ContainsFocusedElement(this FrameworkElement element)
        {
            if (element != null)
            {
                //TODO: Review focus logic
                DependencyObject focusedDependencyObject =
                    //FocusManager.GetFocusedElement(element) as DependencyObject;
                    _focusManagerGetFocusedElementMethodInfo.Invoke(null, new[] { element }) as DependencyObject;
        ...
        public static void SetStyleWithType(this FrameworkElement element, ControlTheme style)
        {
            if (element.Theme != style && (style == null || style.TargetType != null))
            {
                element.Theme = style;
            }
        }
