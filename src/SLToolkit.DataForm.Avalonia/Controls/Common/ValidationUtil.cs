...
namespace SLToolkit.DataForm.WPF.Controls
{
    ...
    internal static class ValidationUtil
    {
        ...
        public static bool ElementHasErrors(DependencyObject element)
        {
            ...
            if (DataValidationErrors.GetHasErrors((Control)element))
            {
                return true;
            }
            else
            {
                ...
                {
                    DependencyObject childElement = (DependencyObject)VisualTreeHelper.GetChild(element, i);
                    /*
        ...
        public static IList<BindingExpressionBase> GetBindingExpressionsForElement(FrameworkElement element)
        {
            List<BindingExpressionBase> bindingExpressions = new List<BindingExpressionBase>();
            ...
            foreach (DependencyProperty dependencyProperty in dependencyProperties)
            {
                ...
                {
                    /*
                    BindingExpressionBase bindingExpression = element.GetBindingExpression(dependencyProperty);
        ...
        public static List<DataFormBindingInfo> GetDataFormBindingInfo(this FrameworkElement element, object dataItem, bool twoWayOnly, bool searchChildren, params Type[] excludedTypes)
        {
            ...
            while (children.Count != 0)
            {
                ...
                if (searchChild)
                {
                    ...
                    {
                        children.Push((DependencyObject)VisualTreeHelper.GetChild(child, childIndex));
