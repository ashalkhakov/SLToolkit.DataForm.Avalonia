...
namespace SLToolkit.DataForm.WPF.Controls
{
    ...
    */
    public class DataField : ContentControl
    {
        ...
        /// </summary>
        public static readonly StyledProperty<FrameworkElement> ContentProperty =
            DependencyProperty.Register<DataField, FrameworkElement>(
                "Content");

        /// <summary>
        /// Content property changed handler.
        /// </summary>
        /// <param name="field">Field that changed its Content value.</param>
        /// <param name="e">The DependencyPropertyChangedEventArgs for this event.</param>
        private static void OnContentPropertyChanged(DataField field, DependencyPropertyChangedEventArgs e)
        {
            field.GenerateUI();
        }
        ...
        public static readonly StyledProperty<string> DescriptionProperty =
            DependencyProperty.Register<DataField, string>(
                "Description");

        /// <summary>
        /// Description property changed handler.
        /// </summary>
        /// <param name="field">Field that changed its Description value.</param>
        /// <param name="e">The DependencyPropertyChangedEventArgs for this event.</param>
        private static void OnDescriptionPropertyChanged(DataField field, DependencyPropertyChangedEventArgs e)
        {
        ...
        /// Identifies the DescriptionViewerPosition dependency property.
        /// </summary>
        public static readonly StyledProperty<DataFieldDescriptionViewerPosition> DescriptionViewerPositionProperty =
            DependencyProperty.Register<DataField, DataFieldDescriptionViewerPosition>(
        ...
        /// </summary>
        /// <param name="field">Field that changed its DescriptionViewerPosition value.</param>
        /// <param name="e">The DependencyPropertyChangedEventArgs for this event.</param>
        private static void OnDescriptionViewerPositionPropertyChanged(DataField field, DependencyPropertyChangedEventArgs e)
        {
            field.GenerateUI();
        }
        ...
        /// </summary>
        public static readonly StyledProperty<ControlTheme> DescriptionViewerStyleProperty =
            DependencyProperty.Register<DataField, ControlTheme>(
                "DescriptionViewerStyle");

        /// <summary>
        /// DescriptionViewerStyle property changed handler.
        /// </summary>
        /// <param name="field">Field that changed its DescriptionViewerStyle value.</param>
        /// <param name="e">The DependencyPropertyChangedEventArgs for this event.</param>
        private static void OnDescriptionViewerStylePropertyChanged(DataField field, DependencyPropertyChangedEventArgs e)
        {
            if (field.DescriptionViewer != null)
            {
                field.DescriptionViewer.Theme = field.DescriptionViewerStyle;
                field.GenerateUI();
            }
        }
        ...
        /// </summary>
        public static readonly StyledProperty<bool> DescriptionViewerVisibilityProperty =
            DependencyProperty.Register<DataField, bool>(
        ...
        public static readonly StyledProperty<object> LabelProperty =
            DependencyProperty.Register<DataField, object>(
                "Label");

        /// <summary>
        /// Label property changed handler.
        /// </summary>
        /// <param name="field">Field that changed its Label value.</param>
        /// <param name="e">The DependencyPropertyChangedEventArgs for this event.</param>
        private static void OnLabelPropertyChanged(DataField field, DependencyPropertyChangedEventArgs e)
        {
        ...
        /// </summary>
        public static readonly StyledProperty<DataFieldLabelPosition> LabelPositionProperty =
            DependencyProperty.Register<DataField, DataFieldLabelPosition>(
                "LabelPosition",
        ...
        /// </summary>
        /// <param name="field">Field that changed its LabelPosition value.</param>
        /// <param name="e">The DependencyPropertyChangedEventArgs for this event.</param>
        private static void OnLabelPositionPropertyChanged(DataField field, DependencyPropertyChangedEventArgs e)
        {
            field.GenerateUI();
        }
        ...
        /// </summary>
        public static readonly StyledProperty<ControlTheme> LabelStyleProperty =
            DependencyProperty.Register<DataField, ControlTheme>(
                "LabelStyle");
        ...
        /// </summary>
        /// <param name="field">Field that changed its LabelStyle value.</param>
        /// <param name="e">The DependencyPropertyChangedEventArgs for this event.</param>
        private static void OnLabelStylePropertyChanged(DataField field, DependencyPropertyChangedEventArgs e)
        {
            if (field.InternalLabel != null)
            {
                field.InternalLabel.Theme = field.LabelStyle;
                field.GenerateUI();
            }
        }
        ...
        /// </summary>
        public static readonly StyledProperty<bool> LabelVisibilityProperty =
            DependencyProperty.Register<DataField, bool>(
                "LabelVisibility",
                true);
        ...
        /// </summary>
        public static readonly StyledProperty<bool> IsFieldGroupProperty =
            DependencyProperty.RegisterAttached<Panel, DataField, bool>(
            "IsFieldGroup");
        ...
        /// </summary>
        /// <param name="field">Field that changed its IsReadOnly value.</param>
        /// <param name="e">The DependencyPropertyChangedEventArgs for this event.</param>
        private static void OnIsReadOnlyPropertyChanged(DataField field, DependencyPropertyChangedEventArgs e)
        {
        ...
        /// </summary>
        /// <param name="field">Field that changed its IsRequired value.</param>
        /// <param name="e">The DependencyPropertyChangedEventArgs for this event.</param>
        private static void OnIsRequiredPropertyChanged(DataField field, DependencyPropertyChangedEventArgs e)
        {
            if (!field.AreHandlersSuspended())
            {
        ...
        /// </summary>
        public static readonly StyledProperty<DataFieldMode> ModeProperty =
            DependencyProperty.Register<DataField, DataFieldMode>(
                "Mode",
                DataFieldMode.Auto);
        ...
        /// <param name="field">Field that changed its IsReadOnly value.</param>
        /// <param name="e">The DependencyPropertyChangedEventArgs for this event.</param>
        private static void OnModePropertyChanged(DataField field, DependencyPropertyChangedEventArgs e)
        {
            field.GenerateUI();
            field.UpdateStates();
        }
        ...
        /// </summary>
        /// <param name="field">Field that changed its PropertyPath value.</param>
        /// <param name="e">The DependencyPropertyChangedEventArgs for this event.</param>
        private static void OnPropertyPathPropertyChanged(DataField field, DependencyPropertyChangedEventArgs e)
        {
        ...
        /// </summary>
        internal static readonly StyledProperty<IList<DataField>> GroupedFieldListProperty =
            DependencyProperty.RegisterAttached<DataField, UIElement, IList<DataField>>(
            "GroupedFieldList");

        /// <summary>
        /// Identifies the DataFormDescriptionViewerPosition dependency property.
        /// </summary>
        private static readonly StyledProperty<DataFieldDescriptionViewerPosition> DataFormDescriptionViewerPositionProperty =
            DependencyProperty.Register<DataField, DataFieldDescriptionViewerPosition>(
        ...
        /// </summary>
        /// <param name="field">Field that changed its DataFormDescriptionViewerPosition value.</param>
        /// <param name="e">The DependencyPropertyChangedEventArgs for this event.</param>
        private static void OnDataFormDescriptionViewerPositionPropertyChanged(DataField field, DependencyPropertyChangedEventArgs e)
        {
        ...
        /// </summary>
        private static readonly StyledProperty<DataFieldLabelPosition> DataFormLabelPositionProperty =
            DependencyProperty.Register<DataField, DataFieldLabelPosition>(
        ...
        /// </summary>
        /// <param name="field">Field that changed its DataFormLabelPosition value.</param>
        /// <param name="e">The DependencyPropertyChangedEventArgs for this event.</param>
        private static void OnDataFormLabelPositionPropertyChanged(DataField field, DependencyPropertyChangedEventArgs e)
        {
        ...
        /// </summary>
        private static readonly StyledProperty<DataFormMode> DataFormModeProperty =
            DependencyProperty.Register<DataField, DataFormMode>(
                "DataFormMode");
        ...
        /// <param name="field">Field that changed its DataFormLabelPosition value.</param>
        /// <param name="e">The DependencyPropertyChangedEventArgs for this event.</param>
        private static void OnDataFormModePropertyChanged(DataField field, DependencyPropertyChangedEventArgs e)
        {
        ...
        static DataField()
        {
            ContentProperty.Changed.AddClassHandler<DataField>(OnContentPropertyChanged);
            DescriptionProperty.Changed.AddClassHandler<DataField>(OnDescriptionPropertyChanged);
            DescriptionViewerPositionProperty.Changed.AddClassHandler<DataField>(OnDescriptionViewerPositionPropertyChanged);
            DescriptionViewerStyleProperty.Changed.AddClassHandler<DataField>(OnDescriptionViewerStylePropertyChanged);
            LabelProperty.Changed.AddClassHandler<DataField>(OnLabelPropertyChanged);
            LabelPositionProperty.Changed.AddClassHandler<DataField>(OnLabelPositionPropertyChanged);
            LabelStyleProperty.Changed.AddClassHandler<DataField>(OnLabelStylePropertyChanged);
            IsReadOnlyProperty.Changed.AddClassHandler<DataField>(OnIsReadOnlyPropertyChanged);
            IsRequiredProperty.Changed.AddClassHandler<DataField>(OnIsRequiredPropertyChanged);
            ModeProperty.Changed.AddClassHandler<DataField>(OnModePropertyChanged);
            PropertyPathProperty.Changed.AddClassHandler<DataField>(OnPropertyPathPropertyChanged);
            DataFormDescriptionViewerPositionProperty.Changed.AddClassHandler<DataField>(OnDataFormDescriptionViewerPositionPropertyChanged);
            DataFormLabelPositionProperty.Changed.AddClassHandler<DataField>(OnDataFormLabelPositionPropertyChanged);
            DataFormModeProperty.Changed.AddClassHandler<DataField>(OnDataFormModePropertyChanged);
        }

        protected override Type StyleKeyOverride => typeof(DataField);
        ...
        /// </summary>
        public ControlTheme DescriptionViewerStyle
        {
            get
            {
                return this.GetValue(DescriptionViewerStyleProperty) as ControlTheme;
            }
        ...
        /// </summary>
        public bool DescriptionViewerVisibility
        {
            get
            {
                return (bool)this.GetValue(DescriptionViewerVisibilityProperty);
            }
        ...
        /// </summary>
        public ControlTheme LabelStyle
        {
            get
            {
                return this.GetValue(LabelStyleProperty) as ControlTheme;
            }
        ...
        public bool LabelVisibility
        {
            get
            {
                return (bool)this.GetValue(LabelVisibilityProperty);
            }
        ...
        protected override void OnApplyTemplate(TemplateAppliedEventArgs e)
        {
            ...
            this._contentControl = e.NameScope.Find<ContentControl>("ContentControl");
        ...
        private void GenerateUI()
        {
            ...
            this.InternalLabel.Bind(Controls.Label.PropertyPathProperty, new Binding("PropertyPath") { Source = this });
            this.InternalLabel.Bind(Controls.Label.IsVisibleProperty, new Binding("LabelVisibility") { Source = this });
            ...
            labelGrid.Bind(FrameworkElement.HorizontalAlignmentProperty, new Binding("HorizontalAlignment") { Source = this.InternalLabel });
            grid.Children.Add(labelGrid);

            this.InternalLabel.PointerPressed += this.OnLabelMouseLeftButtonDown;
            this.InternalLabel.SizeChanged += this.OnLabelSizeChanged;
            ...
            this.DescriptionViewer.Bind(DescriptionViewer.PropertyPathProperty, new Binding("PropertyPath") { Source = this });
            this.DescriptionViewer.Bind(DescriptionViewer.IsVisibleProperty, new Binding("DescriptionViewerVisibility") { Source = this });
            ...
            this.DescriptionViewer.SizeChanged += this.OnDescriptionSizeChanged;
        ...
        /// <param name="sender">The element.</param>
        /// <param name="e">The event args.</param>
        private void OnLabelMouseLeftButtonDown(object sender, PointerPressedEventArgs e)
        {
            e.Handled = true;
        ...
        private void SetContentReadOnlyState(bool isReadOnly)
        {
            ...
            while (dependencyObjectStack.Count > 0)
            {
                ...
                {
                    dependencyObjectStack.Push(VisualTreeHelper.GetChild(curObject, i) as AvaloniaObject);
                }
            }
        }
        ...
        private void SetDescriptionContent()
        {
            if (this.DescriptionViewer != null)
            {
                ...
                {
                    this.DescriptionViewer.Theme = this.DescriptionViewerStyle;
                }
            }
        }
        ...
        private void SetLabelContent()
        {
            if (this.InternalLabel != null)
            {
                ...
                {
                    this.InternalLabel.Theme = this.LabelStyle;
                }
                else
                {
                    if (this.EffectiveLabelPosition != DataFieldLabelPosition.Top)
                    {
                        this.InternalLabel.HorizontalAlignment = global::Avalonia.Layout.HorizontalAlignment.Right;
                    }
                    else
                    {
                        this.InternalLabel.HorizontalAlignment = global::Avalonia.Layout.HorizontalAlignment.Left;
                    }
                }
            }
        }
        ...
        private void SetBindingsFromParentDataForm(DataForm parentDataForm)
        {
            ...
            if (parentDataForm != null)
            {
                this.Bind(DataField.DataFormModeProperty, new Binding("Mode") { Source = parentDataForm });
                this.Bind(DataField.DataFormLabelPositionProperty, new Binding("LabelPosition") { Source = parentDataForm });
                this.Bind(DataField.DataFormDescriptionViewerPositionProperty, new Binding("DescriptionViewerPosition") { Source = parentDataForm });

                this.Bind(DataField.ThemeProperty, new Binding("DataFieldStyle") { Source = parentDataForm });
#if false
                ...
                foreach (DependencyProperty dependencyProperty in dependencyProperties)
                {
                    if (dependencyProperty != null)
                    {
                        ...
                        if (bindingExpression != null && bindingExpression.ParentBinding != null)
                        {
                            ...
                            element.Bind(dependencyProperty, binding);
                        }
                    }
                }
#endif
