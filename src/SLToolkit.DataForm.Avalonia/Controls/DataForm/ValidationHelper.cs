...
namespace SLToolkit.DataForm.WPF.Controls
{
    ...
    {
        internal static readonly DependencyProperty ValidationMetadataProperty =
            DependencyProperty.RegisterAttached<ValidationHelper, FrameworkElement, ValidationMetadata>(
                "ValidationMetadata");
        ...
        internal static ValidationMetadata ParseMetadata(FrameworkElement element, bool forceUpdate, out object entity, out BindingExpressionBase bindingExpression)
        {
            entity = null;
